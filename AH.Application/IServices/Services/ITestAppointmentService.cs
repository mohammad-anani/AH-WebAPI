...
namespace AH.Application.IServices
{
    ...
    public interface ITestAppointmentService : IService
    {
        ...
        Task<GetAllResponseDataDTO<TestAppointmentRowDTO>> GetAllAsync(TestAppointmentFilterDTO filterDTO);
        ...
        /// <returns>Response containing test appointment row DTOs and count</returns>
        Task<GetAllResponseDataDTO<TestAppointmentRowDTO>> GetAllByPatientIDAsync(TestAppointmentFilterDTO filterDTO);
        ...
        /// <returns>The ID of the newly created test appointment</returns>
        Task<int> AddFromTestOrderAsync(CreateTestAppointmentFromTestOrderDTO createDTO);
