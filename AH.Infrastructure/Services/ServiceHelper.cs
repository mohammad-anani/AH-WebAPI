    ...
    public static class ServiceHelper
    {
        public static void AddServiceParameters(ServiceFilter serviceFilter, SqlCommand cmd)
        {
            ...
            var parameters = new Dictionary<string, (object? Value, SqlDbType Type, int? Size, ParameterDirection? Direction)>
            {
                ...
                ["Reason"] = (serviceFilter.Reason, SqlDbType.NVarChar, 200, null),
                ["Result"] = (serviceFilter.Result, SqlDbType.NVarChar, 500, null),
                ...
                ["BillID"] = (serviceFilter.BillID, SqlDbType.Int, null, null)
            };
